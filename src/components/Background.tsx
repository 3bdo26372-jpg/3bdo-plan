...
const CAST: Record<BgVariant, EmojiKey[]> = {
  ...
  lower: ['stopwatch', 'fire', 'droplet', 'runner', 'heart', 'bolt', 'trophy', 'leg'],
...
const SLOTS: Slot[] = [
  ...
  { x:  1, y: 38, size:  64, depth: 0.3, anim: 2, delay: 3.0, desktopOnly: true },
  ...
  { x:  4, y: 82, size:  86, depth: 0.55, anim: 4, delay: 2.1, desktopOnly: true },
...
function Floater({ slot, emoji, index, scrollY, pointerX, pointerY }: FloaterProps) {
  ...
  const opacity = 0.2 + slot.depth * 0.32
